...
class Achievements {
	public static var achievementsStuff:Array<Dynamic> = [ //Name, Description, Achievement save tag, Hidden achievement
		["Falling Star",	"Beat Pheobe in Week 1!",						'neon-nits',	 false],
		
		["What the Duck Doin?",	"Travel across the multiverse and beat Duck Pheobe!",	'rescooted',	true],
		["Turn it off and on again",	"Travel across the multiverse and beat the PC!",	'kernal-panic',	true],
		["Bring out the big guns!",	"Travel across the multiverse and beat the Tank Woman!",	'battlefield-frenzy',	true],
		["This is bigger than us...",	"Neutralize the threat.",	'nullruption',	true]
	];
